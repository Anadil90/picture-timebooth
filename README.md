...
## User stories 
As a new user of the website, the following would be expected: 
- A landing page that gives me the whole idea of what the website is about, and what it can offer me.
- A page to register as a new user, with a form that gives me meaningful information about the fields I should fill out. I should be notified if the registration process was successful, and if not, then the reason why.
- A page to log in with my user information and also a link to reset my password in case I forget it. I should have a visual feedback of which field is incorrectly filled in case there is a typo.
- A main page where I can create the snapshots and see the comments on the snapshot I created.
